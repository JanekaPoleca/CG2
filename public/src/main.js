...
const main = () => {
    ...
    p1.addTimeTransform( t => m4.rotationZ(0.00008 * t) )

    let p2 = new Planet(gl, 3, '/res/earth.jpg', universe)
    p2.addTimeTransform( t => m4.rotationZ(0.00025 *t), true)
    p2.addTransform( m4.translation([42,0,0]))
    p2.addTimeTransform( t => m4.rotationZ(0.00012 *t))
    ...
    p4.addTimeTransform( t => m4.rotationZ(0.0001 *t), true)
    p4.addTransform( m4.translation([102,0,0]))
    p4.addTimeTransform( t => m4.rotationZ(0.00005 *t))

    let p5 = new Planet(gl, 10, '/res/jupiter.jpg', universe)
    p5.addTimeTransform( t => m4.rotationZ(0.00001 *t), true)
    p5.addTransform( m4.translation([150,0,0]))
    p5.addTimeTransform( t => m4.rotationZ(0.00011 *t))

    let s2 = new Planet(gl, 2, '/res/ceres_fictional.jpg', p5)
    s2.addTimeTransform( t => m4.rotationZ(0.0001 *t) , true)
    s2.addTransform( m4.translation([13,0,0]))
    s2.addTimeTransform( t => m4.rotationZ(0.00001 *t))

    let s3 = new Planet(gl, 4, '/res/saturn.jpg', p5)
    s3.addTimeTransform( t => m4.rotationZ(0.0005 *t), true)
    s3.addTransform( m4.translation([25,0,0]))
    s3.addTimeTransform( t => m4.rotationZ(0.0007 *t))

    let s4 = new Planet(gl, 1, '/res/uranus.jpg', s3)
    s4.addTimeTransform( t => m4.rotationZ(0.0005 *t), true)
    ...
    p6.addTimeTransform( t => m4.rotationZ(0.0002 *t), true)
