 ...
 * Satellite Class
 */
 class Satellite extends VisualObject {
    static vs = `
    ...
    void main() {
        v_texCoord = texcoord;
        v_position = u_worldViewProjection * (u_spin * position * u_transform * u_orbit * u_transform2 * u_orbit2);
    ...
    update(time) {
        ...
        this.uniforms.u_orbit2 = this.parent.uniforms.u_orbit; 
        this.uniforms.u_transform2 = this.parent.uniforms.u_transform;
    }
